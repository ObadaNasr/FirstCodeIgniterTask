                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 3rem; float: right;">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?=site_url('PlayerController')?>">Players<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?=site_url('PlayerController/matches')?>">matches</a>
                        </li>
                    </ul>
                    <form method="POST" action="<?=site_url('PlayerController/logOut');?>" >
